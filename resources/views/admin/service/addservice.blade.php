            ...
            <div class="card">
              <div class="card-body">
                ...
                <span class="pull-right">
                    <a href="{{url('admin/viewServices')}}" class="pull-right btn btn-back">
                        <i class="fa fa-reply">&nbsp;&nbsp;Go Back</i></a>
                    </span>

                <p class="card-text">
                    <form action="{{ route('storeservice') }}" class="form-image-upload" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
